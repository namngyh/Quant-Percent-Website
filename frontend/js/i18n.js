...
const I18n = (() => {
  ...
  const DICT = {
    'ws.workspace': { vi: 'Không gian nghiên cứu', en: 'Research workspace' },
    'ws.search': { vi: 'Tìm công cụ', en: 'Find a tool' },
    'ws.fullscreen': { vi: 'Toàn màn hình', en: 'Fullscreen' },
    'ws.exitFullscreen': { vi: 'Thoát toàn màn hình', en: 'Exit fullscreen' },
    'ws.layout1': { vi: 'Một biểu đồ', en: 'One chart' },
    'ws.layout2': { vi: 'Hai biểu đồ', en: 'Two charts' },
    'ws.layout4': { vi: 'Bốn biểu đồ', en: 'Four charts' },
    'ws.analysis': { vi: 'Phân tích', en: 'Analysis' },
    'ws.research': { vi: 'Nghiên cứu', en: 'Research' },
    'ws.researchSpace': { vi: 'Không gian định lượng', en: 'Quantitative workspace' },
    'ws.marketWorkspace': { vi: 'KHÔNG GIAN THỊ TRƯỜNG', en: 'MARKET WORKSPACE' },
    'ws.charts': { vi: 'Biểu đồ thị trường', en: 'Market charts' },
    'ws.autosaved': { vi: 'Bố cục tự lưu', en: 'Layout autosaved' },
    'ws.chartHint': { vi: 'Cuộn để thu phóng · Kéo để xem lịch sử', en: 'Scroll to zoom · Drag to explore history' },
    'ws.commandPlaceholder': { vi: 'Tìm công cụ, biểu đồ, thị trường…', en: 'Find tools, charts, markets…' },
    'ws.close': { vi: 'Đóng', en: 'Close' },
    'ws.closePanel': { vi: 'Đóng bảng công cụ', en: 'Close tool panel' },
    'ws.quickAccess': { vi: 'Truy cập nhanh', en: 'Quick access' },
    'ws.commandHint': { vi: '↑ ↓ di chuyển · Enter để mở', en: '↑ ↓ navigate · Enter to open' },
    'ws.noCommands': { vi: 'Không tìm thấy công cụ phù hợp.', en: 'No matching tools found.' },
    'ws.chooseMarket': { vi: 'Tìm và chọn thị trường', en: 'Find and select a market' },
    'ws.openPanel': { vi: 'Mở bảng công cụ', en: 'Open tool panel' },
    'ws.chartLayout': { vi: 'Sắp xếp không gian biểu đồ', en: 'Arrange your chart workspace' },
    // ---------------- top bar
    ...
    'st.startPaper':      { vi: 'Chạy giao dịch mô phỏng', en: 'Start simulated trading' },
    ...
    // ---------------- paper panel
    'paper.title':        { vi: 'Giao dịch mô phỏng', en: 'Simulated trading' },
    'paper.lead':         { vi: 'Theo dõi chiến lược trên dữ liệu thật bằng tiền mô phỏng. Giá, tài sản và lãi/lỗ được cập nhật theo thời gian thực; phiên vẫn chạy khi bạn đóng trình duyệt.', en: 'Follow strategies on live data with simulated money. Price, equity and P&L update in real time, and sessions keep running when you close the browser.' },
    ...
    'tg.on':              { vi: 'Đang bật qua <strong>@{bot}</strong>. Mỗi lần phiên mô phỏng vào hoặc đóng lệnh sẽ có tin nhắn.', en: 'Active via <strong>@{bot}</strong>. You get a message whenever a simulated session opens or closes a trade.' },
    ...
    'ps.title':           { vi: 'Cài đặt giao dịch mô phỏng', en: 'Simulated trading settings' },
    'ps.hint':            { vi: 'Phiên mô phỏng sẽ khoá các thông số này lúc bắt đầu. Đổi ở đây không ảnh hưởng tới phiên đang chạy, và cũng không ảnh hưởng tới backtest.',
                            en: 'A simulated session freezes these when it starts. Changing them here does not affect a running session, and does not affect the backtest.' },
    ...
    'pf.paper':           { vi: 'Mô phỏng giao dịch cả danh mục',
                            en: 'Simulate the whole portfolio' },
    ...
    'ed.title':           { vi: 'Viết chỉ báo / chiến lược', en: 'Write an indicator or strategy' },
    'ed.open':            { vi: 'Viết code', en: 'Write code' },
    'ed.indicator':       { vi: 'Chỉ báo', en: 'Indicator' },
    'ed.strategy':        { vi: 'Chiến lược', en: 'Strategy' },
    'ed.newFile':         { vi: '— File mới —', en: '— New file —' },
    'ed.template':        { vi: 'Chèn khung mẫu', en: 'Insert a template' },
    'ed.save':            { vi: 'Lưu & nạp', en: 'Save & load' },
    'ed.saving':          { vi: 'Đang lưu…', en: 'Saving…' },
    'ed.saved':           { vi: 'Đã lưu {name} và nạp lại', en: 'Saved {name} and reloaded' },
    'ed.needName':        { vi: 'Đặt tên file trước khi lưu.', en: 'Name the file before saving.' },
