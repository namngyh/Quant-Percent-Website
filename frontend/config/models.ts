...
export const MODELS: ModelConfig[] = [
  ...
  },
  {
    ...
    sparkline: [1.23, 2.82, 3.99, 5.73, 8.17, 9.84],
    sparklineLabel: {
  ...
  },
  {
    ...
    description: {
      ...
      validation: {
        vi: "Mô hình được kiểm tra 20 lần theo thứ tự thời gian, có khoảng cách giữa dữ liệu học và dữ liệu kiểm tra để tránh nhìn trước. Phần dự báo căng thẳng chưa tốt hơn cách dự báo đơn giản.",
        en: "The model was tested 20 times in chronological order, with gaps between learning and test data to prevent looking ahead. Its stress forecast did not beat a simple method.",
      },
      outputs: {
      ...
      limitations: {
        vi: ["Không dự báo giá và không chứng minh quan hệ nguyên nhân–kết quả", "Dùng danh sách VN30 hiện tại cho cả dữ liệu quá khứ nên có thể bỏ sót các cổ phiếu đã bị loại", "Phần dự báo căng thẳng chưa tốt hơn cách dùng tần suất lịch sử"],
        en: ["Does not forecast price or establish causality", "Uses the current VN30 list historically and therefore has survivorship bias", "Stress forecasting has not beaten historical frequency"],
      },
    },
  },
  {
